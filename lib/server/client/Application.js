...
exports.default = () => {
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement(semantic_ui_react_1.Container, { style: { marginTop: '7em' } },
            react_1.default.createElement(react_router_dom_1.Switch, null, routes.map(route => (react_1.default.createElement(react_router_dom_1.Route, Object.assign({ key: route.path }, route))))))));
};
{ /* <AnimatedSwitch
atEnter={{ opacity: 0 }}
atLeave={{ opacity: 0 }}
