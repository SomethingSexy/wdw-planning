...
const ParkItem = ({ park }) => {
    ...
    return (react_1.default.createElement(LocationItem_1.default, { description: item.description, detailPath: `/parks/${item.id}/activities`, key: item.id, icon: free_brands_svg_icons_1.faFortAwesome, id: item.id, image: `public/${item.image}.jpg`, meta: meta, name: item.name, tags: item.areas, type: "Theme Park" }));
};
