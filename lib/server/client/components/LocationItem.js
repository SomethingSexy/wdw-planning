...
const LocationItem = ({ description, icon, id, image, meta, name, tags, type }) => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(semantic_ui_react_1.Item.Content, null,
            ...
            tags && react_1.default.createElement(semantic_ui_react_1.Item.Extra, null, tags.map((tag, index) => react_1.default.createElement(semantic_ui_react_1.Label, { key: index }, tag))))));
};
