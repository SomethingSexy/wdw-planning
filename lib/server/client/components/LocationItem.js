...
const LocationItem = ({ description, icon, id, image, meta, name, detailPath, tags = [], type }) => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        image && react_1.default.createElement(semantic_ui_react_1.Item.Image, { size: "small", src: image }),
        react_1.default.createElement(semantic_ui_react_1.Item.Content, null,
            react_1.default.createElement(semantic_ui_react_1.Item.Header, null,
                react_1.default.createElement(react_router_dom_1.Link, { to: detailPath }, name)),
