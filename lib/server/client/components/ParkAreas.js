...
const ParkAreas = ({ park }) => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(semantic_ui_react_1.List, { animated: true, divided: true, relaxed: true, selection: true, verticalAlign: "middle" }, park.areas.map((area, index) => renderArea(park, area, index)))));
};
